...
//  MMInstapic
//
//  Created by Sherrie Jones on 4/19/15.
...
- (void)applyStyleSheet {
    [[UINavigationBar appearance] setTitleTextAttributes:@{NSForegroundColorAttributeName: [UIColor colorWithRed:0.01 green:0.28 blue:0.48 alpha:1.00]}];
    [[UINavigationBar appearance] setTintColor:[UIColor colorWithRed:0.01 green:0.28 blue:0.48 alpha:1.00]];

    [[UITabBar appearance] setTintColor:[UIColor whiteColor]];
    [[UITabBar appearance] setBarTintColor:[UIColor colorWithRed:0.01 green:0.28 blue:0.48 alpha:1.00]];
